      ...
      <WidthControl>
        <div className=" my-24 mt-14 mx-0 md:-ml-7 xl:ml-0 ">
          <div className=" flex justify-center items-center flex-col py-5  w-full ">
            ...
            <h2 className=" capitalize pb-0 sm:pb-14 font-Poppins text-[#16205F] text-[42px] font-semibold ">
              the best price
            </h2>
          </div>
          ...
          <div className="w-full flex sm:hidden mb-5 justify-center" >
            <PriceSlider pricedetails={pricedetails} ></PriceSlider>
          </div>
        </div>
      </WidthControl>
    </div>
